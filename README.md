...
- Мини-CRM: статусы лида, избранное и заметки, сохраняются в браузере; экспорт их учитывает.
- Обзор рынка по выборке: доля независимых, контактность, средний балл, разбивка по категориям и районам.
